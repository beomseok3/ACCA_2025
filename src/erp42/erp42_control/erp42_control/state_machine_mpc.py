...
class StateMachine:
    def __init__(self, node, odometry, path, state, db):
        ...
        self.min_pub = node.create_publisher(Int64, "min", qos_profile=qos_profile_system_default)
        self.max_pub = node.create_publisher(Int64, "max", qos_profile=qos_profile_system_default)
        self.db_speed_pub = node.create_publisher(Int64, "db_speed", qos_profile=qos_profile_system_default)
        self.idx_pub = node.create_publisher(Int64, "idx", qos_profile=qos_profile_system_default)
