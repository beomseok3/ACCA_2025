...
class mpc_config:
    ...
    Rk: list = field(
        ...
        default_factory=lambda: np.diag([0.1, 80.0])
...
class MPC(Node):
    ...
    def __init__(self, db):
        ...
        self.drive_pub = self.create_publisher(ControlMessage, drive_topic, 1) # cmd_msgs
    ...
    def pose_callback(self, pose_msg):
        ...
        self.drive_msg.steer = int(m.degrees(steer_output))
        self.drive_msg.speed = int((-1.0 if self.is_real else 1.0) * (speed_output * 3.6))
        self.drive_pub.publish(self.drive_msg)
        print("steering ={}, speed ={}".format(self.drive_msg.steer, self.drive_msg.speed))
