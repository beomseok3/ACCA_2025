...
def generate_launch_description():
    ...
    erp_twist_node = launch_ros.actions.Node(
        package="localization",
        executable="erp_twist_world_lpf",
        name="erp_twist_world_lpf",
    )

    bicyle_steer_estimation = launch_ros.actions.Node(
        package="localization",
        executable="bicycle_steer_estimation",
        name="bicycle_steer_estimation",
    )
